...
$stmt = $conn->prepare("INSERT INTO computer_inventory (employee_name, employee_role, employee_phone, employee_email, equipment_type, brand, ip_address, mac_address, has_antivirus_license, has_office_license, has_windows_license, compliance_due_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
